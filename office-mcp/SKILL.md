...
# Basic Information
name: office-mcp
description: "Office MCP 服务器，提供 39 个工具操作 Word/Excel/PPT/PDF/OCR。MCP server with 39 tools for Word, Excel, PowerPoint, PDF, OCR operations. Use as backend service for office-related skills (docx/pptx/xlsx/smart-ocr). Triggered when office document operations are needed."
version: "2.1"
