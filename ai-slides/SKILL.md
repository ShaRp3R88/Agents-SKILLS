...
# Basic Information
name: ai-slides
description: "AI 从主题自动生成完整演示文稿内容。Use when user wants presentation content creation from a topic/concept. NOT for .pptx file operations (use pptx), NOT for visual design advice (use ppt-visual), NOT for Marp markdown slides (use md-slides)."
version: "1.0"
