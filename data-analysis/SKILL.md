...
# Basic Information
name: data-analysis
description: "电子表格数据分析和洞察生成。Analyze spreadsheet data, generate insights, create visualizations. Use when user wants data analysis from Excel/CSV. NOT for report document output (use report-generator), NOT for chart config generation (use chart-designer)."
version: "1.0.0"
