...
name: drawio
version: "2.2.0"
description: "专业图表绘制（流程图/架构图/UML/论文配图），支持 6 主题 YAML 设计系统。Desktop-first Draw.io diagram creation with YAML design system (6 themes). Use for technical diagrams, system architecture, network diagrams, flowcharts, UML, ER diagrams, paper figures, IEEE-style diagrams, roadmaps. Accepts Mermaid/CSV/YAML input. NOT for sketch-style diagrams (use excalidraw-diagram)."
metadata:
