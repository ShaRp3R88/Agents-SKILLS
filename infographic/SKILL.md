...
name: infographic
description: "信息图布局和内容结构设计。Design infographic layouts with data storytelling, icons, and text hierarchy. Use when user wants visual information design or data-driven infographics."
version: "1.0.0"
