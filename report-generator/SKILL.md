...
description: "生成格式化数据报告文档（DOCX/PDF），含图表和可视化。Generate formatted report documents with charts, tables. NOT for data analysis (use data-analysis), NOT for chart configuration (use chart-designer)."
version: "1.0"
