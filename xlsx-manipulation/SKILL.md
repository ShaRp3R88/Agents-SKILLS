...
description: "使用 openpyxl 以代码方式操作 Excel（公式、样式、图表代码）。Programmatic Excel automation with openpyxl: formulas, styles, conditional formatting, charts. Use when needing code-based Excel manipulation. For general spreadsheet read/write/edit use xlsx skill."
version: "1.0"
