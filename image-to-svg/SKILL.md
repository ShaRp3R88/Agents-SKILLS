...
name: image-to-svg
version: 1.8.0
description: "将位图（照片、绘画、插图、线稿）转换为 SVG 矢量图。Convert raster images to SVG vector reproductions via tracing/vectorization. Use when user uploads images to vectorize or trace. NOT for creating original SVG from text descriptions."
---
