...
name: ppt-visual
description: "演示文稿视觉设计和布局建议。仅提供视觉设计咨询和布局建议，不操作 .pptx 文件。Provide slide design specs, visual concepts, layout advice. Does NOT create or edit .pptx files (use pptx for file ops, ai-slides for content generation)."
version: "1.0.0"
