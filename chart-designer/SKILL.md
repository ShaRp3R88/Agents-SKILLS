...
name: chart-designer
description: "数据可视化图表设计（ECharts / Chart.js 等库的配置生成）。Design data visualizations and chart configs for web libraries. NOT for generating report documents (use report-generator), NOT for data analysis (use data-analysis)."
version: "1.0.0"
