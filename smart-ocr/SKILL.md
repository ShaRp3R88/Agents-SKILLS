...
# Basic Information
name: smart-ocr
description: "使用 PaddleOCR 从图像和扫描文档中提取文字，支持 100+ 语言、多语言混合识别、版面分析。支持图像 OCR、扫描 PDF 全文识别，返回文本及位置置信度。Use when extracting text from images or scanned PDFs via PaddleOCR. Supports 100+ languages, layout analysis, with position confidence."
version: "1.0"
