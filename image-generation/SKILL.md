...
description: "AI 生图提示词编写（DALL-E / Midjourney / Stable Diffusion）。Create effective AI image generation prompts for various styles and use cases. Use when user wants to generate images via text-to-image tools."
version: "1.0.0"
