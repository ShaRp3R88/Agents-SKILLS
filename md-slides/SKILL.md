...
# Basic Information
name: md-slides
description: "使用 Marp 从纯 Markdown 创建演示文稿，支持导出为 PDF/PPTX/HTML。提供幻灯片主题、分页指令、布局控制，快速将文档转为专业幻灯片。Use when creating presentations from Markdown via Marp engine. NOT for .pptx file editing (use pptx)."
version: "1.0"
